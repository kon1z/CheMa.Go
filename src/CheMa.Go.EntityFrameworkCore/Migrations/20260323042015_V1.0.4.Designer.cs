...
namespace CheMa.Go.Migrations
{
    ...
    [Migration("20260323042015_V1.0.4")]
    partial class V104
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppHotelIdentityUser", b =>
                {
                    b.Property<long>("HotelId")
                        .HasColumnType("bigint");

                    b.Property<Guid>("HotelUsersId")
                        .HasColumnType("uuid");

                    b.HasKey("HotelId", "HotelUsersId");

                    b.HasIndex("HotelUsersId");

                    b.ToTable("AppHotelIdentityUser");
                });

            modelBuilder.Entity("CheMa.Go.Domain.Entities.DispatchLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CheMa.Go.Domain.Entities.Hotel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CheMa.Go.Domain.Entities.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CheMa.Go.Domain.Entities.Vehicle", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AppHotelIdentityUser", b =>
                {
                    b.HasOne("CheMa.Go.Domain.Entities.Hotel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CheMa.Go.Domain.Entities.Order", b =>
                {
                    ...
                    b.OwnsOne("CheMa.Go.Domain.Entities.LocationInfo", "Location", b1 =>
                        {
