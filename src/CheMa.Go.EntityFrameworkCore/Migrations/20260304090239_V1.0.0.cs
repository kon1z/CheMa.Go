        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseNum = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                name: "AppHotelIdentityUser",
                columns: table => new
                {
                    HotelId = table.Column<long>(type: "bigint", nullable: false),
                    HotelUsersId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppHotelIdentityUser", x => new { x.HotelId, x.HotelUsersId });
                    table.ForeignKey(
                        name: "FK_AppHotelIdentityUser_AbpUsers_HotelUsersId",
                        column: x => x.HotelUsersId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppHotelIdentityUser_AppHotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlightInfo_DepartureTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    FlightInfo_FlightNumber = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppHotelIdentityUser_HotelUsersId",
                table: "AppHotelIdentityUser",
                column: "HotelUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_AppOrders_DriverId",
                table: "AppOrders",
                column: "DriverId");
